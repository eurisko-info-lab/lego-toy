...
def tokenPiece : Piece := {
  ...
  grammar := [
    ...
    ("Token.mathrel", ((lit "≈").alt ((lit "≅").alt ((lit "≤").alt ((lit "≥").alt ((lit "≡").alt (lit "≃"))))))),
...
def mainTokenProds : List String := ["Token.comment", "Token.ws", "Token.hashident", "Token.special", "Token.operator", "Token.string", "Token.char", "Token.ident", "Token.number"]
